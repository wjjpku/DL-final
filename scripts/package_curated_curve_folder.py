#!/usr/bin/env python3
"""Create a curated root-level folder with non-duplicated curve figures and notes."""
...
OUT = ROOT / "curated_curve_package"

FILES = {
    "01_train_set_overview.png": ROOT / "results" / "dataset_overview" / "official_train_set_only.png",
    "02_dataset_structure.png": ROOT / "results" / "dataset_overview" / "dataset_structure.png",
    "03_avg_train_mae_compare.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "official_avg_train_mae_compare.png",
    "04_avg_test_mae_compare.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "official_avg_test_mae_compare.png",
    "05_constant_24000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_constant_24000.png",
    "06_cosine_24000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_cosine_24000.png",
    "07_wsdcon_9_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_wsdcon_9.png",
    "08_constant_72000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_constant_72000.png",
    "09_cosine_72000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_cosine_72000.png",
    "10_wsd_20000_24000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_wsd_20000_24000.png",
    "11_wsdld_20000_24000_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_wsdld_20000_24000.png",
    "12_wsdcon_3_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_wsdcon_3.png",
    "13_wsdcon_18_example.png": ROOT / "results" / "paper_reproduction" / "mpl_vs_tissue_compare" / "100_compare_wsdcon_18.png",
}


README_TEXT = """# Curated Curve Package
